export default [{
    ...
    users: [{
      ...
      id: 'u2',
      name: 'Lukas',
      imageUri: 'https://randomuser.me/api/portraits/men/57.jpg',
    }],
    lastMessage: {
      id: 'm1',
    ...
    users: [{
      ...
      id: 'u3',
      imageUri: 'https://randomuser.me/api/portraits/men/56.jpg',
      name: 'Daniil',
    }],
    lastMessage: {
      id: 'm2',
    ...
    users: [{
      ...
      id: 'u4',
      imageUri: 'https://randomuser.me/api/portraits/men/55.jpg',
      name: 'Alex',
    }],
    lastMessage: {
      id: 'm3',
    ...
    users: [{
      ...
      id: 'u5',
      imageUri: 'https://randomuser.me/api/portraits/men/54.jpg',
      name: 'Vlad',
    }],
    lastMessage: {
      id: 'm4',
    ...
    users: [{
      ...
      id: 'u6',
      name: 'Elon Musk',
      imageUri: 'https://randomuser.me/api/portraits/men/58.jpg',
    }],
    lastMessage: {
      id: 'm5',
    ...
    users: [{
      ...
      id: 'u10',
      imageUri: 'https://randomuser.me/api/portraits/men/19.jpg',
      name: 'Supriatna',
    }],
    lastMessage: {
      id: 'm9',
